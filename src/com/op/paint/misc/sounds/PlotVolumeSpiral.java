package com.op.paint.misc.sounds;
...
public class PlotVolumeSpiral {
	...
	protected void saveImage() throws Exception {
		...
		if (addBorder) {
			...
			int wd = (int) (border);
			int hd = (int) (border);
			BufferedImage opImage2 = RendererUtils.createBufferedImage(ww, hh);
		...
		if (outFileExt.equals(".png")) {
			...
			RendererUtils.saveJPGFile(opImage3, fFile1, dpi);
		}
		opG.dispose();
